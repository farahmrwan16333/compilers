...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        input->setGeometry(QRect(10, 50, 451, 421));
        output = new QTextEdit(centralwidget);
        output->setObjectName("output");
        output->setGeometry(QRect(480, 50, 451, 421));
        ...
        label_2->setGeometry(QRect(650, 0, 111, 41));
        QFont font1;
        ...
        label_3->setGeometry(QRect(1180, 0, 171, 41));
        label_3->setFont(font);
        layoutWidget = new QWidget(centralwidget);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(530, 490, 401, 51));
        ...
        label_4->setGeometry(QRect(1130, 50, 351, 411));
        MainWindow->setCentralWidget(centralwidget);
        menubar = new QMenuBar(MainWindow);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 1553, 21));
        ...
        QObject::connect(parseButton, &QPushButton::clicked, label_4, qOverload<>(&QLabel::clear));
